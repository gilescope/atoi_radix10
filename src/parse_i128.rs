use super::{parse_16_chars, parse_4_chars, parse_8_chars, ParseIntError2, ParseIntError3};
use core::num::IntErrorKind::*;

type PIE = ParseIntError2;

pub fn parse_i128_challenger(s: &[u8]) -> Result<i128, ParseIntError3> {
    //    parse_i128(s)
    super::parse::<i128>(s)
}
pub fn parse_i128(s: &[u8]) -> Result<i128, ParseIntError3> {
    //    parse_i128(s)
    super::parse::<i128>(s)
}
