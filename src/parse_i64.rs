use super::{
    parse_16_chars, parse_4_chars, parse_8_chars, trees::TENS_U64, ParseIntError2, ParseIntError3,
};
...
//     }
// }
pub fn parse_i64(s: &[u8]) -> Result<i64, ParseIntError3> {
    //    parse_i128(s)
    super::parse::<i64>(s)
}
pub fn parse_i64_challenger(s: &[u8]) -> Result<i64, ParseIntError3> {
    //    parse_i128(s)
    super::parse::<i64>(s)
}
